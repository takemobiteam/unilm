...
class DataTrainingArguments:
    ...
    dataset_name: Optional[str] = field(
        default='unum_qa', metadata={"help": "The name of the dataset to use (via the datasets library)."}
    )
...
def main():
    ...
    if data_args.dataset_name == 'unum_qa':
        # datasets = load_dataset("nielsr/unum_qa")
        import layoutlmft.data.unum_qa
        datasets = load_dataset(os.path.abspath(layoutlmft.data.unum_qa.__file__), cache_dir=model_args.cache_dir)
